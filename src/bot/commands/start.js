...
function buildGuideLines(ctx) {
  const lines = [
    ...
    '🚀 /onboard — pick your role, desired income, and skills before you can apply to tasks',
  ...
  if (isAdmin(ctx)) {
    lines.push(
      ...
      '✍️ /assign <application_id> — assign an applicant (up to the task\'s max_assignees)',
      ...
      '🕵️ /review <application_id> approve|reject|revise [note] — handle that application\'s latest submission',
      '📡 /enablesignals — turn on auto-drafting from this group\'s messages',
      '🔕 /disablesignals — turn it off for this group',
      'ℹ️ /signalstatus — check whether this chat is being watched',
      '',
